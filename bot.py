...
class Platoky(Base):
    ...
    nazvanije_platka: Mapped[str]=mapped_column(String(128), nullable=False)
    avtor_platka: Mapped[str]=mapped_column(String(128), nullable=False)
    kolorit_1: Mapped[str]=mapped_column(String(128), nullable=False)
    kolorit_2: Mapped[str] = mapped_column(String(128), nullable=False)
    kolorit_3: Mapped[str] = mapped_column(String(128), nullable=False)
    kolorit_4: Mapped[str] = mapped_column(String(128), nullable=False)
    kolorit_5: Mapped[str] = mapped_column(String(128), nullable=False)
    uzor_temeni: Mapped[str] = mapped_column(String(128), nullable=False)
    uzor_serdceviny: Mapped[str] = mapped_column(String(128), nullable=False)
    uzor_storon: Mapped[str] = mapped_column(String(128), nullable=False)
    uzor_uglov: Mapped[str] = mapped_column(String(128), nullable=False)
    uzor_kraja: Mapped[str] = mapped_column(String(128), nullable=False)
    cvety_ornament: Mapped[str] = mapped_column(String(128), nullable=False)
    izobrazheniy_cvetok_1: Mapped[str] = mapped_column(String(128), nullable=False)
    izobrazheniy_cvetok_2: Mapped[str] = mapped_column(String(128), nullable=False)
    izobrazheniy_cvetok_3: Mapped[str] = mapped_column(String(128), nullable=False)
    izobrazheniy_cvetok_4: Mapped[str] = mapped_column(String(128), nullable=False)
    izobrazheniy_cvetok_5: Mapped[str] = mapped_column(String(128), nullable=False)
    razmer_platka: Mapped[str]=mapped_column(String(10), nullable=False)
    material_platka: Mapped[str]=mapped_column(String(128), nullable=False)
    material_bahromi: Mapped[str]=mapped_column(String(128), nullable=False)
...
from klaviatury import klava_poisk1, klava_poisk2, klava_kolorit, klava_posobiy, klava_material, klava_bahroma
